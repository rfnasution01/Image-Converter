			...
			<section className="relative px-4 py-12 sm:px-6 lg:px-8">
				<div className="mx-auto max-w-6xl">
					<div className="mx-auto max-w-3xl text-center">
						...
						<h1 className="mt-5 font-heading text-4xl font-extrabold tracking-[-0.04em] text-slate-950 sm:text-6xl">
								...
								<div className="min-w-0">
									...
									<div className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
										...
										<Button
											...
											className="mt-4 h-11 w-full rounded-xl bg-blue-600 font-semibold shadow-lg shadow-blue-600/20 hover:bg-blue-700"
										>
											{copiedAddress ? (
						...
						<aside className="space-y-6">
							<section className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.10)] backdrop-blur">
								...
								<a
									...
									target="_blank"
									rel="noreferrer"
									className="mt-5 inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 text-base font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5 hover:bg-blue-700"
								>
